  ...
  return (
    <>
      ...
      <nav>
        ...
        <button className="nav-cta">GITHUB LOGIN</button>
      </nav>
      ...
      <section className="hero grid-bg">
        <div className="hero-text">
          ...
          <div className="hero-buttons">
            <button className="btn-primary">⬡ ANALYZE A REPOSITORY</button>
            <button className="btn-secondary">◎ EXPLORE THE GIT UNIVERSE</button>
          </div>
          <div className="repo-input-wrapper">
            <div className="repo-input-box">
              <span className="repo-prefix">github.com/</span>
              <input type="text" placeholder="username" />
              <button className="repo-analyze-btn">EXPLORE →</button>
            </div>
          </div>
        </div>
      ...
      <section className="viz-section" id="viz">
        ...
        <div className="viz-demo fade-up">
          {[
            ...
            <div key={idx} className="viz-card viz-card-clickable" onClick={() => setExpandedViz(idx)}>
      ...
      {/* VIZ EXPAND OVERLAY */}
      {expandedViz !== null && (
        <div className="viz-overlay" onClick={() => setExpandedViz(null)}>
          <div className="viz-expanded" onClick={(e) => e.stopPropagation()}>
            <div className="viz-expanded-header">
              ...
              <button className="viz-close-btn" onClick={() => setExpandedViz(null)}>✕</button>
            </div>
            {expandedViz === 3 ? (
          ...
          <div className="why-items">
            {[
              ...
              <div
                ...
                onClick={() => { setActiveWhy(i); setWhyTimerKey((k) => k + 1) }}
              >
      ...
      <section className="cta-section">
        <div className="fade-up">
          ...
          <button className="btn-primary" style={{ fontSize: 13, padding: '18px 40px' }}>⬡ START ANALYZING REPOSITORIES</button>
        </div>
      </section>
