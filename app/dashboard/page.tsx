                    ...
                    {group.items.map((item) => (
                      <button
                        ...
                        onClick={() => {
                          ...
                          else if (item === 'Instant Repo Explanation') router.push('/dashboard/explain')
                          else if (item === 'Onboarding Guide Generator') router.push('/dashboard/onboarding')
                          else if (item === 'Learning Path Generator') router.push('/dashboard/learning-path')
                          else if (item === 'Automatic TODO Extraction') router.push('/dashboard/todos')
                          else if (item === 'PR Impact Prediction') router.push('/dashboard/pr-impact')
                          else if (item === 'Refactor Opportunity Detection') router.push('/dashboard/refactor')
                          else if (item === 'Repo Ecosystem Map') router.push('/dashboard/ecosystem-map')
                          else if (item === 'Underrated Repo Finder') router.push('/dashboard/underrated')
                          else if (item === 'Repo Similarity Engine') router.push('/dashboard/similarity')
                          else if (item === 'Emerging Tech Radar') router.push('/dashboard/tech-radar')
                          else if (item === 'Startup Ideas from Repos') router.push('/dashboard/startup-ideas')
                          else if (item === 'Duplicate Project Detection') router.push('/dashboard/duplicates')
                          else if (item === 'Vulnerability Scanner') router.push('/dashboard/vuln-scan')
                          else if (item === 'Secret & Credential Leak Detection') router.push('/dashboard/secret-scan')
                          else if (item === 'License Compliance Checker') router.push('/dashboard/license-check')
                          else if (item === 'Outdated Dependency Alerts') router.push('/dashboard/outdated-deps')
                          else if (item === 'Supply Chain Risk Scoring') router.push('/dashboard/supply-chain')
                          else if (item === 'Security Patch Tracking') router.push('/dashboard/patch-tracking')
                        }}
                        style={{
